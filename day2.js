...
people.splice(1, 0, ...people.splice(-2));
...
if (!values[0]) falsy.push(values[0]); else truthy.push(values[0]);

// value at index 1
// if value is falsy, push it to falsy array
// if value is truthy, push it to truthy array
if (!values[1]) falsy.push(values[1]); else truthy.push(values[1]);

// value at index 2
// if value is falsy, push it to falsy array
// if value is truthy, push it to truthy array
if (!values[2]) falsy.push(values[2]); else truthy.push(values[2]);

// value at index 3
// if value is falsy, push it to falsy array
// if value is truthy, push it to truthy array
if (!values[3]) falsy.push(values[3]); else truthy.push(values[3]);

// value at index 4
// if value is falsy, push it to falsy array
// if value is truthy, push it to truthy array
if (!values[4]) falsy.push(values[4]); else truthy.push(values[4]);
...
let displayName = trimmed[0].toUpperCase() + trimmed.slice(1).toLowerCase();
